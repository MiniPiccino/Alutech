...
def build_prompt_with_budget(user_question: str,
    ...
    header = (
        ...
        "- Poduzeća RICAT i ALUTECH smatraju se istim poduzećem. Ako korisnik pita za Alutech, odgovori koristeći informacije o Ricatu, kao da se radi o istom poduzeću.\n"
